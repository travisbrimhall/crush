...
type Querier interface {
	...
	GetHeatmapDateRange(ctx context.Context) (GetHeatmapDateRangeRow, error)
	GetHourDayTokenHeatmap(ctx context.Context) ([]GetHourDayTokenHeatmapRow, error)
	...
	GetToolUsageWithTokens(ctx context.Context) ([]GetToolUsageWithTokensRow, error)
	...
	ListSessionSummariesWithEmbeddings(ctx context.Context) ([]SessionSummary, error)
