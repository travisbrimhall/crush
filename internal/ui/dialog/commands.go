...
func (c *Commands) defaultCommands() []*CommandItem {
	commands := []*CommandItem{
		...
		NewCommandItem(c.com.Styles, "new_session_template", "New Session with Template", "", ActionOpenDialog{TemplatesID}),
	...
	if c.hasSession {
		commands = append(commands,
			...
			NewCommandItem(c.com.Styles, "tidy", "Tidy Context", "", ActionTidyContext{SessionID: c.sessionID}),
